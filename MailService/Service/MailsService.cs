...
namespace MailService.Service
{
    public class MailsService
    {
        ...
        public async Task sendEmail(UserMessageDto user , string Message, string? subject="Welcome to Pick-A-Saw")
        {
            MimeMessage message1 = new MimeMessage();

            message1.From.Add(new MailboxAddress("Pick-A-Saw ", _email));
